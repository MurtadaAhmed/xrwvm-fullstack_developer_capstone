...
const Register = () => { 
  ...
  const register = async (e) => {
    ...
    // Send POST payload matching views.py parser schema
    ...
    if (json.status === "Authenticated") {
      // Store user credentials in session storage for navbar updates
    ...
    <div className="register_container" style={{width: "50%"}}>
      ...
      <form onSubmit={register}> 
        ...
        <div className="submit_panel">
          <input className="submit" type="submit" value="Register"/> </div>
      </form> 
    </div>
  );
}; 
